<div class="box box-widget mb-0" style="min-height: 600px;">
    ...
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-th"></i> Profession Search</h3>
    </div>
    ...
    <div class="box-body" style="background: #ddd;">
    	...
    	<div class="w3-border w3-border-purple w3-round w3-white">
						<div class="w3-container w3-padding">
							...
							<form class="cat-subcat-form" action="{{ route('user.userSearchByProfessionAjax') }}" method="post">
								{{csrf_field()}}
                ...
                <div class="form-group ">
                        ...
                        <div class="row">
                            @foreach ($userSettingFields[9]->values->chunk($userSettingFields[9]->values->count()/3) as $value3)
                            <div class="col-sm-4">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="row">
                            @foreach ($userSettingFields[0]->values as $v)
                            <div class="col-sm-4">  
