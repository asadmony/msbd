...
<div class="p-2">
 ...
 <div class="tab-content">
                <div class="tab-pane active" id="time_l">
    ...
    <div class="col-sm-3">
            ...
            @include('user.includes.timeline.timelineSearch')
                ...
                <div class="tab-pane" id="partner_pref">
                    Partner Preference will be here
                </div>

                <div class="tab-pane" id="my_sear">
                    My Search options will be here
                </div>

                
                <div class="tab-pane" id="my_setti">
                    My Settings will be here
                </div>
