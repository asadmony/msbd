            ...
            <div class="col-sm-12">
                <div class="box box-widget w3-border w3-border-purple text-center mb-0">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            Proposal from <span class="w3-tag w3-purple w3-round w3-large"> <a target="_blank"
                                    class="w3-text-white"
                                    href="{{ url('/',$proposal->user->username) }}">{{ $proposal->user->username }}</a>
                            </span> to <span class="w3-tag w3-purple w3-round w3-large"> <a target="_blank"
                                    class="w3-text-white" href="{{ url('/',$proposal->userSecond->username) }}">
                    ...
                    <div class="box-body text-center">
                        ...
                        <a target="_blank" href="{{ url('/',$proposal->user->username) }}">
                            <img class="rounded img-bordered mb-2" title="{{ $proposal->user->username }}" width="80"
                        ...
                        <a target="_blank" href="{{ url('/',$proposal->userSecond->username) }}">
                            <img class="rounded img-bordered mb-2" title="{{ $proposal->userSecond->username }}"
                                width="80" src="{{ asset($proposal->userSecond->latestCheckedPP()) }}"
                    ...
                    <div class="box-footer w3-light-gray">
                        <div class="card mt-0 mb-0">
                            <div class="card-body">
                                ...
                                <a data-url="{{ route('user.cancelProposal', $proposal) }}"
                                ...
                                <a data-url="{{ route('user.acceptProposal', $proposal) }}"
