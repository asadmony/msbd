...
<div class="box">
   ...
   <div class="other-area">
    ...
    @if($me->personalInfo)
@if ($me->personalInfo->education_level == 'Other' || $me->personalInfo->education_level == 'Others')
...
<div class="form-group {{ $errors->has('job_company_name') ? ' has-danger' : '' }}">
   ...
   <div class="other-area">
    ...
    @if($me->personalInfo)
@if ($me->personalInfo->my_profession == 'Other' || $me->personalInfo->my_profession == 'Others')
style="border-radius: 4px;padding-left: 8px;margin-bottom: 25px;" 
@else
style="border-radius: 4px;padding-left: 8px; display: none;margin-bottom: 25px;" 
@endif
...
<div class="other-area">
    <div class="form-group {{ $errors->has('country_of_residence') ? ' has-danger' : '' }}">
        ...
        <select class="simple-select2 w-100 change-with-other" name="country_of_residence" style="width: 100%;">
            <option></option>
            @if($me->personalInfo)
    ...
    <input  
    type="text" 
    id="country_of_residence_other" 
    class="form-control w3-border w3-border-light-gray other-value-field" 
    name="country_of_residence_other"        
    value="{{$me->personalInfo ? $me->personalInfo->country_of_residence_other : ''}}"
    placeholder="Country of residence Other (Please Specify here)" 
    
@if($me->personalInfo)
@if ($me->personalInfo->country_of_residence == 'Other' || $me->personalInfo->country_of_residence == 'Others')
style="border-radius: 4px;padding-left: 8px;margin-bottom: 25px;" 
@else
style="border-radius: 4px;padding-left: 8px; display: none;margin-bottom: 25px;" 
@endif
...
<div class="form-group {{ $errors->has('number_of_brother') ? ' has-danger' : '' }}">
        ...
        <select class="simple-select2 w-100" name="number_of_brother" style="width: 100%;">
            <option></option>
            @if($me->personalInfo)
    ...
    <div class="form-group {{ $errors->has('how_many_brother_married') ? ' has-danger' : '' }}">
        ...
        <select class="simple-select2 w-100" name="how_many_brother_married" style="width: 100%;">
            <option></option>
            @if($me->personalInfo)
 ...
 <div class="form-group {{ $errors->has('number_of_sister') ? ' has-danger' : '' }}">
        ...
        <select class="simple-select2 w-100" name="number_of_sister" style="width: 100%;">
            <option></option>
            @if($me->personalInfo)
    ...
    <div class="form-group {{ $errors->has('how_many_sister_married') ? ' has-danger' : '' }}">
        ...
        <select class="simple-select2 w-100" name="how_many_sister_married" style="width: 100%;">
            <option></option>
            @if($me->personalInfo)
...
@if($me->personalInfo)
@if ($me->personalInfo->disabilities_status == 'Other' || $me->personalInfo->disabilities_status == 'Others')
style="border-radius: 4px;padding-left: 8px;margin-bottom: 25px;" 
@else
style="border-radius: 4px;padding-left: 8px; display: none;margin-bottom: 25px;" 
@endif
...
<div class="box">
	...
	<div class="row">
							@foreach ($userSettingFields[31]->values->chunk($userSettingFields[31]->values->count()/3) as $value3)
							<div class="col-sm-4">
								...
								<div class="form-check">
									<label class="form-check-label">
										<input class="form-check-input" type="checkbox" name="can_speak[]" value="{{ $value->title }}" 
    ...
    <div class="pull-right">
        ...
        <button type="submit" class="btn btn-primary">{{$me->personalInfo ? 'Submit' : 'Next'}}</button>
    </div>
</form>