      ...
      <div class="box-body">
        <div class="panel panel-default">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="number" min="1" required  step="any" class="form-control" id="price" value="{{ old('price') ?: $package->package_amount }}" name="price" placeholder="Package Price/Amount">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="number" min="1" required max="10000" step="1" class="form-control" id="proposal_send_total_limit" value="{{ old('proposal_send_total_limit') ?: $package->proposal_send_total_limit }}" name="proposal_send_total_limit" placeholder="Proposal Send Total Limit">
            </div>
          </div>
