...
id="sectionsNav">
        ...
        <div class="container">
            <div class="navbar-translate">
                ...
                href="{{url('/')}}">
                <img class="img-responsive rounded" src="{{ asset($websiteParameter->logo ? 'storage/logo/'.$websiteParameter->logo : 'img/logo.jpg') }}" alt="{{ env('APP_NAME_BIG') }}" style="width: 154px; margin-top: -16px;">
                </a>
