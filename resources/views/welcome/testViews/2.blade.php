...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" href="{{asset('mk/mk/BS4/assets/img/kit/free/apple-icon.png')}}">
    <link rel="icon" href="{{asset('mk/mk/BS4/assets/img/kit/free/favicon.png')}}">
    <title>
...
<body class="index-page ">
    <nav class="navbar navbar-color-on-scroll navbar-transparent    fixed-top  navbar-expand-lg bg-primary" color-on-scroll="100" id="sectionsNav">
        <div class="container">
            <div class="navbar-translate">
                <a class="navbar-brand" href="./index.html">2.blade.php </a>
    ...
    <div class="page-header header-filter clear-filter purple-filter" data-parallax="true" style="background-image: url({{asset('mk/mk/BS4/assets/img/kit/bg2.jpg')}});">
        <div class="container">
            <div class="row">
    ...
    <div class="main main-raised">
        ...
        <div class="section section-navbars cd-section" id="navigation">
            ...
            <!--             navbar -->
            <div id="navbar">
                <div class="navigation-example" style="background-image: url('assets/img/kit/bg.jpg');">
                                    ...
                                    <li class="dropdown nav-item">
                                        <a href="#pablo" class="profile-photo dropdown-toggle nav-link" data-toggle="dropdown">
                                            <div class="profile-photo-small">
                                                <img src="{{asset('mk/mk/BS4/assets/img/kit/faces/avatar.jpg')}}" alt="Circle Image" class="rounded-circle img-fluid">
                                            </div>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <h6 class="dropdown-header">Dropdown header</h6>
            ...
            <div class="container tim-container">
                ...
                <div id="images">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <h4>Rounded Image</h4>
                            <img src="{{asset('mk/mk/BS4/assets/img/kit/faces/avatar.jpg')}}" alt="Rounded Image" class="rounded img-fluid">
                        </div>
                        ...
                        <div class="col-sm-2 ml-auto">
                            ...
                            <img src="{{asset('mk/mk/BS4/assets/img/kit/faces/avatar.jpg')}}" alt="Raised Image" class="img-raised rounded img-fluid">
                        </div>
                        <div class="col-sm-2 ml-auto">
                            <h4>Circle Raised</h4>
                            <img src="{{asset('mk/mk/BS4/assets/img/kit/faces/avatar.jpg')}}" alt="Thumbnail Image" class="img-raised rounded-circle img-fluid">
                        </div>
                    </div>
                    <div class="row">
                    </div>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="{{asset('mk/mk/BS4/assets/img/kit/bg2.jpg')}}" alt="First slide">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{asset('mk/mk/BS4/assets/img/kit/bg3.jpg')}}" alt="Second slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h4>
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{asset('mk/mk/BS4/assets/img/kit/bg.jpg')}}" alt="Third slide">
                                        <div class="carousel-caption d-none d-md-block">
                                            <h4>
                                                <i class="material-icons">location_on</i> Yellowstone National Park, United States
                                            </h4>
        ...
        <div class="section section-signup page-header" style="background-image: url({{asset('mk/mk/BS4/assets/img/kit/free/city.jpg')}});">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="examples/landing-page.html" target="_blank">
                            <img src="{{asset('mk/mk/BS4/assets/img/kit/free/landing.jpg')}}" alt="Rounded Image" class="img-raised rounded img-fluid">
                            <button class="btn  btn-link btn-primary btn-lg">View Landing Page</button>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="examples/profile-page.html" target="_blank">
                            <img src="{{asset('mk/mk/BS4/assets/img/kit/free/profile.jpg')}}" alt="Rounded Image" class="img-raised rounded img-fluid">
