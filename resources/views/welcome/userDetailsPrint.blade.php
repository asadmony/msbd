...
<body onload="window.print();">
          ...
          <h2 class="page-header">
            <div class="w3-row">
              <div class="w3-col" style="width:80px">
                <img style="margin-top: -5px;" class="img-responsive w3-circle w3-border w3-border-red" width="60" src="{{ asset($websiteParameter->logo ? 'storage/logo/'.$websiteParameter->logo : 'img/logo.jpg') }}" alt="{{env('APP_NAME_BIG')}}">
              </div>
 ...
 @include('user.includes.print.printUserBasic')


 @include('user.includes.print.printUserEduInfo')
 @include('user.includes.print.printUserWorkInfo')
 @include('user.includes.print.printUserPersonalInfo')
 @include('user.includes.print.printUserFamilyInfo')
 @include('user.includes.print.printUserPartnerPreference')
