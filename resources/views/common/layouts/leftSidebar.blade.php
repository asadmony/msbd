...
<li class="treeview {{ session('lsbm') == 'payments' ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ session('lsbsm') == 'paymentAddNew' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common2.paymentAddNew')}}"><i class="fa fa-circle-o"></i> Add New Payment</a></li>
 
            <li class="{{ session('lsbsm') == 'allPendingPayments' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common2.allPendingPayments')}}"><i class="fa fa-circle-o"></i> All Pending Payments</a></li>

            <li class="{{ session('lsbsm') == 'allPaidPayments' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common2.allPaidPayments')}}"><i class="fa fa-circle-o"></i> All Paid Payments</a></li>

            <li class="{{ session('lsbsm') == 'allFreePayments' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common2.allFreePayments')}}"><i class="fa fa-circle-o"></i> All Free Payments</a></li>
          </ul>
        </li>
...
<li class=" treeview{{ session('lsbm') == 'page' ? ' active ' : '' }}">
  ...
  <ul class="treeview-menu">
    ...
    <li class="{{ session('lsbsm') == 'newMenu' ? ' active ' : '' }}"><a href="{{route('common1.newMenu')}}"><i class="fa fa-circle-o"></i> New Menu </a></li>

    <li class="{{ session('lsbsm') == 'allMenus' ? ' active ' : '' }}"><a href="{{route('common1.allMenus')}}"><i class="fa fa-circle-o"></i> All Menus </a></li>



    <li class="{{ session('lsbsm') == 'newPage' ? ' active ' : '' }}"><a href="{{route('common1.newPage')}}"><i class="fa fa-circle-o"></i> New Page </a></li>
    <li class="{{ session('lsbsm') == 'allPages' ? ' active ' : '' }}"><a href="{{route('common1.allPages')}}"><i class="fa fa-circle-o"></i> All Pages </a></li>
...
<li class=" treeview{{ session('lsbm') == 'gallery' ? ' active ' : '' }}">
  ...
  <ul class="treeview-menu">
    ...
    <li class="{{ session('lsbsm') == 'imgGalleryAddNew' ? ' active ' : '' }}"><a href="{{route('common1.imgGalleryAddNew')}}"><i class="fa fa-circle-o"></i> Add New Gallery </a></li>

    <li class="{{ session('lsbsm') == 'imgGalleriesAll' ? ' active ' : '' }}"><a href="{{route('common1.imgGalleriesAll')}}"><i class="fa fa-circle-o"></i> Galleries All </a></li>
...
<li class=" treeview{{ session('lsbm') == 'videoGallery' ? ' active ' : '' }}">
  ...
  <ul class="treeview-menu">
    ...
    <li class="{{ session('lsbsm') == 'videoGalleryAddNew' ? ' active ' : '' }}"><a href="{{route('common1.videoGalleryAddNew')}}"><i class="fa fa-circle-o"></i> Add New Gallery </a></li>

    <li class="{{ session('lsbsm') == 'videoGalleriesAll' ? ' active ' : '' }}"><a href="{{route('common1.videoGalleriesAll')}}"><i class="fa fa-circle-o"></i> Galleries All </a></li>
...
<li class=" treeview{{ session('lsbm') == 'media' ? ' active ' : '' }}">
  ...
  <ul class="treeview-menu">
    <li class="{{ session('lsbsm') == 'mediaAll' ? ' active ' : '' }}"><a href="{{route('common1.mediaAll')}}"><i class="fa fa-circle-o"></i> Media All </a></li>
...
<li class="treeview {{ session('lsbm') == 'proposal' ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ session('lsbsm') == 'all_proposals' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common3.proposalsGroup', 'all_proposals')}}"><i class="fa fa-circle-o"></i> All Proposals</a></li>
 
            <li class="{{ session('lsbsm') == 'pending_proposals' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common3.proposalsGroup', 'pending_proposals')}}"><i class="fa fa-circle-o"></i> All Pending Proposals</a></li>

            <li class="{{ session('lsbsm') == 'accepted_proposals' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common3.proposalsGroup', 'accepted_proposals')}}"><i class="fa fa-circle-o"></i> All Accepted Proposals</a></li>
...
<li class="treeview {{ session('lsbm') == 'users' ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ session('lsbsm') == 'newUser' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common3.newUser')}}"><i class="fa fa-circle-o"></i> Create New User</a></li>
            ...
            <li class="{{ session('lsbsm') == 'profile_picture_pending' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common2.usersGroup','profile_picture_pending')}}"><i class="fa fa-circle-o"></i> Profile Picture Pending</a></li>
            ...
            @endif
             ...
             <li class="{{ session('lsbsm') == 'online_users' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common2.usersGroup','online_users')}}"><i class="fa fa-circle-o"></i> Online (Now) Users</a></li>

             <li class="{{ session('lsbsm') == 'offline_users' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common2.usersGroup','offline_users')}}"><i class="fa fa-circle-o"></i> Offline Profiles</a></li>  



            <li class="{{ session('lsbsm') == 'usersAll' ? 'active' : '' }}"><a class="changed-menu" href="{{route('common2.usersAll')}}"><i class="fa fa-circle-o"></i> All Users</a></li>         
