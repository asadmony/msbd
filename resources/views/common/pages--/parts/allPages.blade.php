...
<div class="btn-group pull-right btn-group-xs">
  <a class="btn btn-primary "  href="{{route('common1.editPage',$page)}}">Edit</a>
  <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
    <span class="caret"></span>
  </button>
  <ul class="dropdown-menu" role="menu">
    <li><a onclick="return confirm('Do you want to delete this page?');" href="{{route('common1.deletePage', $page)}}">Delete</a></li>
