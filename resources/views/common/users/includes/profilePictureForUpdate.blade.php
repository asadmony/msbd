...
<div class="fb-profile">
        ...
        @include('common.users.ajax.userProfilePic')
        ...
        <form id="form_profilepic_upload" method="post" enctype="multipart/form-data" action="{{route('common2.userProfilepicChange', $user)}}">
        {{csrf_field()}}
