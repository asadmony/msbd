<div class="box box-widget w3-animate-zoom" >
  ...
  <form class="form-inline" action="{{ route('common2.uploadNewPublicPhotos', [$user, 'public']) }}" method="post" enctype="multipart/form-data">
 <div class="row">
   <div class="col-sm-7">
          ...
          <div class="col-sm-3">
            ...
            <div class="w3-display-container " style="width:100%;margin-top: 15px;">
              ...
              <div class="w3-display-bottomright w3-display-hover ">
                <a class="btn btn-danger btn-sm" onclick="return confirm('Do you want to delete it');" href="{{ route('common2.userPhotoDelete',$photo) }}">Delete</a>
              </div>
