<div class="box box-widget">
        ...
        <div class="box-body" style="background-color: #ccc;">
          <div class="row">
           <div class="col-md-7">
            ...
            <form class="form-horizontal" method="post" action="{{route('common1.videoGalleryEditPost',$videoGallery)}}">
            ...
            <div class="box box-widget">
              <div class="box-body">
               ...
               <div class="form-group {{ $errors->has('date') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-9">
                    <input type="date" name="date" class="form-control" value="{{old('date') ?: $videoGallery->date}}" id="date" placeholder="Date of the video" autocomplete="off">
                    @if ($errors->has('date'))
                    <span class="help-block">
  ...
  <div class="col-md-5">
    ...
    <iframe width="400" height="290" src="{{asset($videoGallery->video_url)}}?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
