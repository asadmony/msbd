<div class="box box-widget">
        ...
        <div class="box-body" style="background-color: #ccc;">
          <div class="row">
           <div class="col-md-7">
            ...
            <form class="form-horizontal" method="post" action="{{route('common1.imgGalleryEditPost',$imageGallery)}}">
            ...
            <div class="box box-widget">
              <div class="box-body">
                ...
                <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="title" class="form-control" value="{{old('title') ?: $imageGallery->title}}" id="title" placeholder="Title of Post" autocomplete="off">
                    @if ($errors->has('title'))
               ...
               <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="description" class="form-control" value="{{old('description') ?: $imageGallery->description}}" id="description" placeholder="Short Description about the gallery" autocomplete="off">
               ...
               <div class="form-group {{ $errors->has('date') ? ' has-error' : '' }}">
                  <label for="date" class="col-sm-3 control-label">Gallery Date</label>
                  <div class="col-sm-9">
                    <input type="date" name="date" class="form-control" value="{{old('date') ?: $imageGallery->date}}" id="date" placeholder="Date of the gallery" autocomplete="off">
                    @if ($errors->has('date'))
                    <span class="help-block">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 col-sm-offset-3">
            <div class="checkbox">
              <label><input type="checkbox"  name="publish" {{$imageGallery->publish_status == 'published' ? 'checked' : ''}}>Publish Instantly</label>
            </div>                  
          </div>
        </div>
    ...
    <div class="box box-widget">
    <div class="box-body">
      <form class="form-horizontal gallery-item-form" method="post" action="{{route('common1.imgGalleryItemAjaxPost',$item)}}">
