        ...
        <div class="box-body" style="background-color: #ccc;">
          <div class="row">
           <div class="col-md-7">
            ...
            <form class="form-horizontal" method="post" action="{{route('common1.imgGalleryAddNewPost')}}">
            ...
            <div class="box box-widget">
              <div class="box-body">
               ...
               <div class="form-group {{ $errors->has('date') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-9">
                    <input type="date" name="date" class="form-control" value="{{old('date')}}" id="date" placeholder="date of the gallery" autocomplete="off">
                    @if ($errors->has('date'))
                    <span class="help-block">
