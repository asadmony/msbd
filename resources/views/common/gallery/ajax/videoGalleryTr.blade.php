...
<td width="100">
	...
	<div class="btn-group btn-group-xs pull-right ">
		<a class="btn btn-primary"  href="{{route('common1.videoGalleryEdit',$gallery)}}">Edit</a>
		...
		<ul class="dropdown-menu" role="menu">
			...
			<li><a href="{{route('common1.videoGalleryDelete',$gallery)}}" onclick="return confirm('Do you really want to delete this gallery?');">Delete</a></li>
		</ul>                  
	</div>
