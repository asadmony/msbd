...
{{-- <link href="{{ asset('http://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.11/summernote.css') }}"
rel="stylesheet"> --}}
@endpush

@section('content')
@include('common.pages.parts.pageItemEdit')
@endsection
...
<script type="text/javascript" src="{{asset('//cdnjs.cloudflare.com/ajax/libs/codemirror/3.20.0/codemirror.js')}}">
</script>
<script type="text/javascript" src="{{asset('//cdnjs.cloudflare.com/ajax/libs/codemirror/3.20.0/mode/xml/xml.js')}}">
</script>
<script type="text/javascript" src="{{asset('//cdnjs.cloudflare.com/ajax/libs/codemirror/2.36.0/formatting.js')}}">
</script>
