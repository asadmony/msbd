...
<section class="content">
        ...
        <div class="col-md-12">
                ...
                <div class="box-body">
                    <div class="box box-widget mb-0">
                        <div class="box-body w3-gray ">
                            @include('common.pages.includes.pageSingleWithoutDel')

                            <div class="row">
                                <div class="col-sm-10 col-sm-offset-1">

                                    @foreach($page->items as $item)
                                    @include('common.pages.includes.pageItemSingle')
                                    @endforeach
            ...
            <div class="box box-widget">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-edit"></i> Update Page Part <span
                            class="label label-default">{{ $it->title }}</span> of <span
                            class="label label-default">{{ $page->page_title }}</span> Page</h3>
                </div>
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <div class="box box-widget mb-0">
                                        <div class="box-body">
                                            ...
                                            @include('common.pages.includes.pagePartEditForm')
    ...
    <a href="javascript::void()" class="w3-btn w3-round w3-white w3-border w3-border-blue"> <i class="fa fa-file-o"></i> Upload File</a>
            ...
            {{-- <div class="box box-widget">
          <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-edit"></i> Page Edit <span class="label label-default">{{ $page->page_title }}</span>
            </h3>
        </div>
