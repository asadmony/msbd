<form class="form-horizontal" role="form" method="post" action="{{route('common2.pendingPaymentUpdatePost', $payment)}}">
...
<div class="form-group {{ $errors->has('payment_details') ? ' has-error' : '' }}">
    ...
    <p>(New Package Duration (days) will be added with previous duration)</p>
 	...
 	<a class="btn btn-warning" onclick="return confirm('Do you really want to delete this payment info?');" href="{{route('common2.paymentDelete', $payment)}}">Delete</a>
