<div class="col-lg-12 order-1 order-lg-2">
    <div class="form-group col-md-6">
                ...
                @foreach($user->activeCompanies() as $company)
                    <div class="form-check">
                        <label class="form-check-label pb-3">
                            <input class="form-check-input" type="radio" name="company" data-msg-required="Please select at least one option." id="inlineRadio1" value="{{$company->title}}" {{$loop->first ? 'checked' : ''}}> {{ucfirst($company->title)}}
                        </label>
                    </div>
                @endforeach
            @endif
        ...
        <div class="form-group ml-0">
            <button type="button" class="btn btn-primary btn-with-arrow  mb-2" data-toggle="modal" data-target="#formModal" href="#">Create New Company<span><i class="fas fa-plus"></i></span></button>
        </div>
                        ...
                        <div class="modal-body">
                            {{-- <form id="demo-form" class="mb-4" novalidate="novalidate"> --}}
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="title" class="form-control" placeholder="company name" required/>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center">
                                    <label class="col-sm-3 text-left text-sm-right mb-0">Company Code</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="company_code" class="form-control" placeholder="Companay code" required/>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center">
