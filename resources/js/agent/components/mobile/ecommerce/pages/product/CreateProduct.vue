                    ...
                    <div>
                        ...
                        <div class="padding-around">
                            <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" v-model="product.product_name" placeholder="Name of product with a some indentical info">
                            </div>
                            <div class="mb-3">
                                    <label class="h6" for="excerpt">Short Description</label>
                                    <textarea class="form-control" type="text" v-model="product.excerpt" rows="3" placeholder="Name of the owner"></textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" v-model="product.product_condition" id="product_condition">
    ...
    methods: {
        ...
        showMoreImages(e){
            ...
            for(var i=0; i<files.length; i++) {
                var file = files[i];
                this.product.more_images.push(file)
