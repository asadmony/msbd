...
// define("SSLCZ_STORE_ID", "marri5c50195c5b357"); //for sandbox
// define("SSLCZ_STORE_PASSWD", "marri5c50195c5b357@ssl"); //for sandbox //sandbox login id: marriagesolutionbd pass: 5BA103CBD259935243

// define("SSLCZ_STORE_ID", "demotest");
// define("SSLCZ_STORE_PASSWD", "qwerty");
define("SSLCZ_STORE_ID", "marriagesolutionbdlive");
define("SSLCZ_STORE_PASSWD", "5BA103CBD259935243");
...
class SSLCommerz
{
    ...
    protected function sendRequest($data)
    {
        ...
        //this curl_exec() not working in production mode (in live server)
            ...
            foreach ($source['desc'] as $key => $volume) {
                if (isset($volume['gw']) && $volume['gw'] == $gw) {
                    if (isset($volume['logo'])) {
                        $logo = Str::replace("/gw/", "/gw1/", $volume['logo']);
                        break;
                    }
                }
            }
